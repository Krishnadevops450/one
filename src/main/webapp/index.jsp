...
<body>
    ...
    <main>
        ...
        <section class="hero" role="img" aria-label="Hero banner">
            <div class="container">
                <h1>Welcome to My Little Collection — Premium Picks</h1>
                <p>Browse your latest trends in fashion, beauty, technology and accessories — curated just for you. Enjoy limited-time deals and free shipping on selected items.</p>
                <div>
